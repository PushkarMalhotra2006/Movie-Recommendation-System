...
# CONFIG
# =============================
API_BASE = "https://movie-recommendation-system-sn0l.onrender.com/" or "http://127.0.0.1:8000"
...
if st.session_state.view == "home":
    ...
    if typed.strip():
        if len(typed.strip()) < 2:
            ...
            if err or data is None:
                ...
                # DYNAMIC SUGGESTIONS BELOW INPUT (instead of dropdown)
                if suggestions:
    ...
    backend_category = home_category.lower().replace(" ","_")

    home_cards, err = api_get_json(
        "/home", params={"category": backend_category, "limit": 24}
    )
